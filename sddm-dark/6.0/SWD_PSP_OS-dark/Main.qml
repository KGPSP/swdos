    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-dark/assets/suspend_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-dark/assets/restart_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-dark/assets/shutdown_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-dark/assets/switch_primary.svgz"
