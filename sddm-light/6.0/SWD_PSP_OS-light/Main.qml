    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-light/assets/suspend_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-light/assets/restart_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-light/assets/shutdown_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SWD_PSP_OS-light/assets/switch_primary.svgz"
